...
function getAll() {
  // let arr = Object.assign(copyObject(dingdong), copyObject(snapshot), copyObject(livestream));
  let arr = Object.assign(copyObject(dingdong), copyObject(snapshot));
  arr.Info = Object.assign(copyObject(info), copyObject(health));
  arr.History = copyObject(history);
  arr.Light = copyObject(light);
  return arr;
}
