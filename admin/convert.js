...
const fs = require('fs');
const langs = {};
Object.keys(systemDictionary).forEach(key => {
    const _langs = Object.keys(systemDictionary[key]);
    _langs.forEach(lang => {
        langs[lang] = langs[lang] || {};
        langs[lang][key] = systemDictionary[key][lang];
    });
});
Object.keys(langs).forEach(lang => {
    fs.writeFileSync(`${__dirname}/i18n/${lang}.json`, JSON.stringify(langs[lang], null, 2));
});
